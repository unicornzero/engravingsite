...
# - Follow instructions at https://developers.google.com/youtube/registering_an_application to setup a new project in Google APIs Console. Be sure to follow steps to toggle YouTube Data API v3 service to ON.
...
* - - Note the password displayed. Add it to config/application.yml as :google_secret_phrase 
##change to google_key_password##
* - - Download the private key and move it into the config/privatekey directory. Update :google_full_key_path and :google_secret_key_path
##change to google_private_key##
...
Notes about scope of Google API requests:
 - by xpepermint at http://stackoverflow.com/questions/14106337/google-api-client-rails/16471252
...
###############################################################
#  Additional topics that may be added later...
#    Ruby version
#    System dependencies
#    Configuration
#    Database creation
